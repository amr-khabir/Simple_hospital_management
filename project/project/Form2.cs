    ...
    public partial class Form2 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (textBox1.Text == "" || textBox2.Text == "" || comboBox1.Text == "")
            {
                ...
                {
                    StreamWriter ski = new StreamWriter("data.txt قسم العيادات", true);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                if (textBox1.Text != "")
                {
                    StreamReader sk = new StreamReader("data.txt قسم العيادات");
                    string skill = "";
                    bool found = false;
                    do
                    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                StreamReader ski = new StreamReader("data.txt قسم العيادات");
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            if (comboBox1.Text == "مراجعة")
                textBox3.Text = "10$";
            if (comboBox1.Text == "معاينة")
                textBox3.Text = "20$";
        }
