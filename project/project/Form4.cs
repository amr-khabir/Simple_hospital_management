...
namespace project
{
    public partial class Form4 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                    StreamWriter ski = new StreamWriter("data.txt قسم التحليل", true);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                if (textBox1.Text != "")
                {
                    StreamReader sk = new StreamReader("data.txt قسم التحليل");
                    string skill = "";
                    bool found = false;
                    do
                    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                StreamReader ski = new StreamReader("data.txt قسم التحليل");
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            if (comboBox1.Text == "دم")
                textBox3.Text = "50$";
            if (comboBox1.Text == "بول")
                textBox3.Text = "40$";
            if (comboBox1.Text == "صورة")
                textBox3.Text = "100$";
        }
